...
<div class="post">
    ...
    <a href="">
<!--    프로필 이미지로 변경-->
    <div class="user-img"><img src="/img/trade/tradeImg/교환물건(2).jpg" alt=""></div>
    <div class="usr-mid">
<!--    memverVO에서 name가져오기-->
...
<!--    업로드한 사진 보이게 만들기-->
        ...
        <li><img src="/img/trade/피드여행(5).jpg" alt=""></li>
        <li><img src="/img/trade/피드여행(6).jpg" alt=""></li>
    </ul>
...
<div class="util-wrap">
    ...
    <span class="count">${comment[i++]}</span>
    </div>
    </div>
    </div>
`;
