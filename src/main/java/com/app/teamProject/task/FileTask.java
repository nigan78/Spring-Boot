//package com.app.teamProject.task;
//
...
//        final List<FeedFileVO> files = feedFileMapper.selectYesterday();
//        final File serverFile = Paths.get("C:/upload/feed", getPathFromYesterday()).toFile();
//        final List<Path> paths = files.stream().map(file -> Paths.get("C:/upload/feed" + file.getFilePath() + "/" + file.getFileUuid() + "_" + file.getFileName()))
